...
public class Example01 {
	public static void main(String[] args) {
		 ...
		 * - 변수에는 다양한 자료형을 담을 수 있다(숫자, 문자, 문자열, boolen 등)
		 * 
		 * 형식)
		 * [데이터타입] [변수명] = [저장할값]
		 * 
		 ...
		 * - 첫 번째 글자는 문자 $, _이어야 하고 숫자로 시작할 수 없다
		 ...
		 *  
		 *  헝가리안 표기법(Hungarian Notation) -> 잘 안 씀
		...
		int iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii = 1000;
		System.out.println(iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii);
		// int #a = 200;
